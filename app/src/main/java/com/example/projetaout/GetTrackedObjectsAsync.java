...
public class GetTrackedObjectsAsync extends AsyncTask<Void, Void, String> {

    private TrackedObjects activity;
    private int IdUser;
    private double LatUser;
    private double LonUser;

    public GetTrackedObjectsAsync (TrackedObjects activity, int IdUser, double lat, double lon)
    {
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            String rpc = "/GetTrackedObject.php";
    ...
    protected void onPostExecute(String chaineJson)
    {
        if(chaineJson.equals("1") || chaineJson.equals("2") || chaineJson.equals("3")){
            ...
            try {
                ...
                this.activity.populate(code_erreur, objects);
    ...
    {
        double latRad, lonRad, tlatRad, tlonRad, midLat, midLon, Distance;
